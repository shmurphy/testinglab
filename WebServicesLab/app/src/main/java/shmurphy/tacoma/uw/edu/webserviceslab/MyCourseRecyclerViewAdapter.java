...
import shmurphy.tacoma.uw.edu.webserviceslab.CourseListFragment.OnListFragmentInteractionListener;
...
public class MyCourseRecyclerViewAdapter extends RecyclerView.Adapter<MyCourseRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(mValues.get(position).getMyCourseId());
