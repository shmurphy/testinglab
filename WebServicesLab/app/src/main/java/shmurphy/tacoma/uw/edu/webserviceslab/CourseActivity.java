...
import shmurphy.tacoma.uw.edu.webserviceslab.authenticate.LoginFragment;
import shmurphy.tacoma.uw.edu.webserviceslab.authenticate.SignInActivity;
...
//        Log.d("ADD COURSE", url);

        AddCourseTask task = new AddCourseTask();
        task.execute(new String[]{url.toString()});

        //returns to previous fragment by popping the current one off the stack
    ...
    private class AddCourseTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                Log.d("debug", "was able to create json object.");
