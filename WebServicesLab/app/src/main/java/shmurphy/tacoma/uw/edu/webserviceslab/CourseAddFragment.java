...
public class CourseAddFragment extends Fragment {
    ...
    private final static String COURSE_ADD_URL = "http://cssgate.insttech.washington.edu/~shmurphy/Android/addCourse.php?";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addCourseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("edit text", "*** THE ID IS: " + mCourseIdEditText.getText().toString());
                Log.d("edit text", "*** THE SHORT DESC IS: " + mCourseShortDescEditText.getText().toString());
